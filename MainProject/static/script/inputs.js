...
function resultPlay(reff,testt,refsrc,testsrc){
    ...
    reflinkdur="0";
    testlinkdur="0";
    var reffnew="<table id='resultTable'><tr><td> <font color='white'><pre style='tab-size:2;'>Reference Note sequence  </pre> </font></td><td><label id='refresult"+k+"'>";
    var testtnew="<tr><td>  <div id='refalignplay'> </div><td> </tr><tr><td><font color='white'><pre style='tab-size:2;' >Test Note sequence  </pre></font></td><td><label id='testresult"+k+"'>";
    ...
    for (i=0;i<ref.length;i++){
        if(ref[i]==tes[i]){
            ...
            if(ref[i]=='-'){
                reffnew=reffnew+"<font color='#61ef7e'>"+" "+"  "+"</font>";
            }
            else{
                reffnew=reffnew+"<font color='#61ef7e'>"+" "+ref[i]+"</font>";
            }
            if(tes[i]=='-'){
                testtnew=testtnew+"<font color='#f42c2b'>"+" "+"  "+"</font>";
            }
            else{
                testtnew=testtnew+"<font color='#f42c2b'>"+" "+tes[i]+"</font>";
            }
    ...
    testtnew= "<b>"+testtnew+"</b></label></td></tr><tr> <td> <div id='testalignplay'></div> </td></tr></table>";
...
//link test string with test audio
    ...
    function createEventListenerRef(t) {
        return async function() {
            document.getElementById("refalignplay").innerHTML="<button id='refplay123'>Play</button><button id='refstop123' style='display: none;'>stop</button><br>";
    ...
    function createEventListenerTest(t) {
        return async function() {
            document.getElementById("testalignplay").innerHTML="<button id='testplay123'>Play</button><button id='teststop123' style='display: none;'>stop</button><br>";
